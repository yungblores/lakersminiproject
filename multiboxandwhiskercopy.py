...
stat_cols = ['Defensive_BPM', 'Offensive_BPM', 'BPM','STL_PCT', 'BLK_PCT', 'DWS', 'WS', 'WS_PER_48']
...
for i, col in enumerate(stat_cols):
    ...
    fig.update_layout(
        title_text=f'Box-and-Whisker Plot of {col}',
        yaxis_title_text=f'{col} Scores',
    )
    
    # Save the figure to an HTML file
    pyo.plot(fig, filename=f'plot{i+1}.html', auto_open=False)
